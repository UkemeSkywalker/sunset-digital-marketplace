...
const Home = () => {
  // Get 3 featured products from sample data
    ...
    <div className="flex flex-col items-center">
            ...
            >
              ...
              <div className="p-4 flex-grow flex flex-col">
                ...
                <div className="mt-auto">
                  <span className="text-sunset-orange font-medium hover:underline">View Details →</span>
                </div>
              </div>
            </Link>
          ))}
      ...
      <div className="w-full bg-gradient-to-r from-sunset-orange to-sunset-yellow text-white py-16">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-xl mb-8 text-primary-100 max-w-2xl mx-auto">
            Join our community of buyers and sellers today and discover the best digital products on the market.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link 
              to="/register" 
...
const steps = [
  {
    ...
    description: "Explore our marketplace of digital products created by talented sellers from around the world."
  },
  {
    title: "Make a Purchase",
    description: "Securely buy the digital products you love with just a few clicks using our trusted payment system."
  },
  {
...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    text: "As a seller, I love how easy it is to list my products and reach customers worldwide."
  },
  {
    name: "Michael Chen",
    role: "Web Developer",
